...
get the app created:
    ...
    Creating hello-heroku... done, stack is cedar
    http://hello-heroku.herokuapp.com/ | git@heroku.com:hello-heroku.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://hello-heroku.herokuapp.com deployed to Heroku

    To git@heroku.com:hello-heroku.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://hello-heroku.herokuap.com
    ["Hello" :from Heroku]
